sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.bancasegurosEmision.controller.MenuBar", {
		...
		_onNavigationListItemSelect: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("HomePage", oBindingContext, fnResolve, "");
		...
		_onNavigationListItemFirstLevelSelect: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("Certificado", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		onInit: function() {
			...
			this.oRouter.getTarget("MenuBar").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
